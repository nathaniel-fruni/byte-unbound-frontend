...
<template>
  ...
  <div class="card card-body shadow-dark rounded-3 p-4">
    <h3 class="text-center mt-2">Spravovanie stage-ov</h3>
    <div class="mb-3 mt-2" v-for="(stage, index) in stages" :key="index">
